...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="dashboard-stat widget-4">
            <div class="dashboard-stat-content">
                <h4>{{ $unoccupied_listings }}</h4> <span>Listings Unoccuppied</span>
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="dashboard-stat widget-6">
            <div class="dashboard-stat-content">
                <h4>{{ $amount_paid }}</h4> <span>Total Amount Paid</span>
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="dashboard-stat widget-7">
            <div class="dashboard-stat-content">
                <h4>{{ $landlord_count }}</h4> <span>Landlords</span>
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="dashboard-stat widget-8">
            <div class="dashboard-stat-content">
                <h4>{{ $agent_count }}</h4> <span>Agents</span>
            </div>
            <div class="dashboard-stat-icon"><i class="ti-user"></i></div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="dashboard-stat widget-9">
            <div class="dashboard-stat-content">
                <h4>{{ $user_count }}</h4> <span>Users</span>
            </div>
            <div class="dashboard-stat-icon"><i class="ti-user"></i></div>
        </div>
    </div>
