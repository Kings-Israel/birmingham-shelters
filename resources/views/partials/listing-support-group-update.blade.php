                        ...
                        <div class="submit-section">
                            <div class="submit-section">
                                <div class="row">
                                            ...
                                            <ul class="no-ul-list">
                                                @foreach ($supported_groups as $group)
                                                    <li>
                                                        <input type="checkbox" class="checkbox-custom" name="supported_groups[]"
                                                            value="{{ $group }}"
                                                            id="a-{{$loop->index}}"
                                                            {{ in_array($group, $listing->supported_groups) ? 'checked' : '' }}>
                                                ...
                                                <li>
                                                    <input id="other-types-checkbox" class="checkbox-custom"
                                                        ...
                                                        {{ in_array('Other', $listing->supported_groups) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-12 {{ !in_array('Other', $listing->supported_groups) ? 'd-none' : '' }}">
