    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-5">
                <img src="{{ asset('/img/hello.svg') }}" class="img-fluid" alt="" />
            </div>
            ...
            <div class="col-lg-7 col-md-7">
                <div class="story-wrap explore-content">
                    ...
                    <p>Sheltered Housing Ltd links homeless persons with quality supported accommodation. It exists to
                        ...
                        Voluntary Services Council (BVSC) ensuring high-quality service is provided. In supported
                        housing, accommodation is provided alongside care, support, or supervision to help people live
                        as independently as possible. <strong>
