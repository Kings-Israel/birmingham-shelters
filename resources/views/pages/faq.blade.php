<x-app-layout>
    <!-- ============================ Page Title Start================================== -->
			<section class="image-cover faq-sec text-center" style="background:url(https://via.placeholder.com/1920x900) no-repeat;" data-overlay="6">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-10 col-md-12 col-sm-12">
							...
							<div class="block-header">
								<ul class="nav nav-tabs customize-tab" id="myTab" role="tablist">
								  ...
								  <li class="nav-item">
									<a class="nav-link" id="upgrade-tab" data-bs-toggle="tab" href="#upgrade" role="tab" aria-controls="upgrade" aria-selected="false">Upgrade</a>
								  </li>
